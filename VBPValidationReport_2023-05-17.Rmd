...
The differences observed between matched and non-matched, compliant and non-compliant is are not statistically significant, and may be attributed to error. This means that the validity of the HCA Value Based Purchasing Quality Roster (VBPQR) is strong enough to draw inferences from the data. 
...
Be that as it may, this assessment if for a new year, and an new vendor, Cotivity. We were pleased to find that for the measurement period (2023-01-01 to 2023-02-28), there was NOT a significant variance in the data. This indicates that the data provided by Cotivity, through the HCA VBP Quality Roster, is valid, and can be used to draw inferences with confidence.

# Reviews

1.  2023-05-18: The Alliance ACO Executive Leadership review
