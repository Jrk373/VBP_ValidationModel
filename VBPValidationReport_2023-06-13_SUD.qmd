...
SUDDxCodes <- read.csv("./data/data_reference_SUDDxCodes.csv")
```
...
IPClaims_SummarySUD <- IPClaims_Summary |> 
  mutate(SUD_Dx = if_else(PrimaryDiagnosis %in% SUD_Dx, PrimaryDiagnosis,
                             if_else(Dx1 %in% SUD_Dx, Dx1,
                                     if_else(Dx2 %in% SUD_Dx, Dx2,
                                             if_else(Dx3 %in% SUD_Dx, Dx3,
                                                     if_else(Dx4 %in% SUD_Dx, Dx4,
                     if_else(Dx5 %in% SUD_Dx, Dx5,
                             if_else(Dx6 %in% SUD_Dx, Dx6,
                                     if_else(Dx7 %in% SUD_Dx, Dx7,
                                             if_else(Dx8 %in% SUD_Dx, Dx8,
                                                     if_else(Dx9 %in% SUD_Dx, Dx9,
                     if_else(Dx10 %in% SUD_Dx, Dx10,
                             if_else(Dx11 %in% SUD_Dx, Dx11,
                                     if_else(Dx12 %in% SUD_Dx, Dx12, "NotSUD"
                                     )))))))))))))) 

IPClaims_SummarySUD <- IPClaims_SummarySUD |>
  mutate(CoOccuring = if_else(Elig_MHDx != "NotBH" & SUD_Dx != "NotSUD", 1, 0))

 write.csv(IPClaims_SummarySUD, "./data/output/VBPMeasurementValidation/IPClaims_SummarySUD.csv")
...
VMMwithDxGroupings <- ValidatedVBPMembers |> 
  mutate(Elig_MHDx = if_else(PrimaryDiagnosis %in% SUD_Dx, PrimaryDiagnosis,
                             if_else(Dx1 %in% SUD_Dx, Dx1,
                                     if_else(Dx2 %in% SUD_Dx, Dx2,
                                             if_else(Dx3 %in% SUD_Dx, Dx3,
                                                     if_else(Dx4 %in% SUD_Dx, Dx4,
                                                                             ...
                                                                             if_else(Dx7 %in% SUD_Dx, Dx7,
                                                                                     if_else(Dx8 %in% SUD_Dx, Dx8,
                                                                                             if_else(Dx9 %in% SUD_Dx, Dx9,
                                                                                                     if_else(Dx10 %in% SUD_Dx, Dx10,
                                                                                                             if_else(Dx11 %in% SUD_Dx, Dx11,
                                                                                                                     if_else(Dx12 %in% SUD_Dx, Dx12, "NotBH"                                                                             ))))))))))))))
# Group by Dx
